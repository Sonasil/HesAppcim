    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'grid gap-4 rounded-lg border shadow-lg duration-200',
          'w-[calc(100vw-max(2rem,env(safe-area-inset-left)+env(safe-area-inset-right)+2rem))]',
          'min-w-[280px] max-w-[90vw] sm:max-w-lg',
          'p-6 sm:p-6',
          'overflow-hidden',
          className,
        )}
